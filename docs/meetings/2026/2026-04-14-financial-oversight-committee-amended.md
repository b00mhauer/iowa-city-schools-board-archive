...
- **[Meeting transcript](transcripts/2026-04-14-financial-oversight-committee-amended.md)** — machine-generated from the YouTube recording; timestamps link to the moment in the video.
- **[Supporting documents (text)](text/29488/index.md)** — machine-extracted text of every attached PDF, linked back to the originals on the district portal.
